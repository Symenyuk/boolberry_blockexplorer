...
export class ApiComponent implements OnInit {
  ...
  ngOnInit() {
    this.objectLinks = {
      url_request_format: 'https://explorer.boolberry.com/api/{method}/{param1}/{param2}',
      utl_get_info: 'https://explorer.boolberry.com/api/get_info/4294967295',
      url_get_blocks_details: 'https://explorer.boolberry.com/api/get_blocks_details/{:offset}/{:count}',
      url_get_main_block_details: 'https://explorer.boolberry.com/api/get_main_block_details/{:hash}',
      url_get_alt_blocks_details: 'https://explorer.boolberry.com/api/get_alt_blocks_details/{:offset}/{:count}',
      url_get_alt_block_details: 'https://explorer.boolberry.com/api/get_alt_block_details/{:hash}',

      url_get_pool_txs_details: 'https://explorer.boolberry.com/api/get_pool_txs_details',
      url_get_pool_txs_brief_details: 'https://explorer.boolberry.com/api/get_pool_txs_brief_details',
      url_get_all_pool_tx_list: 'https://explorer.boolberry.com/api/get_all_pool_tx_list',

      url_get_tx_details: 'https://explorer.boolberry.com/api/get_tx_details/{:tx_hash}'
    };
    this.infoExample = {
      'alias_count': 84,
    ...
    this.geAllPoolTXlist = {
      ...
      'jsonrpc': '2.0',
      'result': {
        'ids': ['313f363308ec6e5ada8e2c7b5faec8a41ccebf87b0a5adcf978af080d2669f32', '7300c0ac204304e068f5f7ea813974a557cd174193ac81253f5b1d17cbc32a43'],
        'status': 'OK'
      }
    };
    this.getTXdetails = {
